...
import org.servingniches.jobboard.config.KafkaProperties;
...
class JhipsterSampleResTfulApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleResTfulApplicationKafkaResource kafkaResource = new JhipsterSampleResTfulApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-res-tful-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-res-tful-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
